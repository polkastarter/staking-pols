...
Example 1000 POLS token staked for 1 week : 1000 _ 10^18 _ 7 _ 24 _ 60 \* 60 = 6.048e+26

If this value is being set as `setStakeRewardFactor` then a user will able claim/mint 1 reward token after staking 1000 staking token for 1 week.
